...
<html lang="en">
  <head>
  	<title>Cpanel Arah-Parking</title>
    <meta charset="utf-8">
					...
					<div class="wrap d-md-flex">
						...
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
							<div class="text w-100">
								<h2 style="text-shadow: 5px 5px 5px black;">Arah-Parking</h2>
								<!-- <p style="text-shadow: 5px 5px 5px black;">PT Arah Tawu Berjaya</p> -->
								<img class="img-fluid" src="<?php echo base_url().'gambar/logo.png' ?>" alt="" width="250px">
							</div>
			      </div>
