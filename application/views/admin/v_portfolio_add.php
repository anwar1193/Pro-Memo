  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tambah Portfolio</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="col-sm-8 offset-2" style="border:1px dashed gray; padding: 10px;">
      ...
      <!-- Form Simpan Format -->
      <form method="post" enctype="multipart/form-data" action="<?php echo base_url().'portfolio/simpan' ?>">
      ...
      <div class="form-group">
          <table width="100%">
              <tr>
                  ...
                  <td width="70%">
                      <input type="text" name="label" class="form-control" required="" autocomplete="off">
                  </td>
              </tr>
          </table>
      </div>
      ...
      <div class="tombol_kirim" style="text-align: center;">
        <button type="submit" class="btn btn-success">
          <i class="fa fa-send-o"></i> Simpan Portfolio
        </button>
