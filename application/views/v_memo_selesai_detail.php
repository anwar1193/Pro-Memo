        ...
        <div class="card">
          ...
          <p>
              ...
              <ul>
                  ...
                  <li>
                      <span style="background-color:red; color:white; padding:2px; border-radius:50%; margin-top:10px"><i class="fas fa-times"></i></span>
                      = Rejected
                  </li>
          ...
          <div class="text-center" style="margin-top:50px">
            <a href="<?php echo base_url().'memo_selesai' ?>" class="btn btn-danger">
