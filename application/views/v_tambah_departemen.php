<?php  
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-8 offset-2" style="border:1px dashed gray; padding: 10px;">
      ...
      <!-- Form Simpan Format -->
      <form method="post" enctype="multipart/form-data" action="<?php echo base_url().'master_departemen/simpan_departemen' ?>">
      ...
      <div class="form-group">
          <table width="100%">
              <tr>
                  ...
                  <td width="70%">
                      <input type="text" name="kode_departemen" class="form-control" required="" autocomplete="off">
                  </td>
              </tr>
          </table>
      </div>
      ...
      <div class="form-group">
          <table width="100%">
              <tr>
                  ...
                  <td width="70%">
                      <input type="text" name="nama_departemen" class="form-control" required="" autocomplete="off">
                  </td>
              </tr>
          </table>
      </div>
      ...
      <div class="tombol_kirim" style="text-align: center;">
        <button type="submit" class="btn btn-success">
          <i class="fa fa-send-o"></i> Simpan Departemen
        </button>
