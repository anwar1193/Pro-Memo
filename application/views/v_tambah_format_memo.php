  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tambah Format Memo</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="col-sm-8 offset-2" style="border:1px dashed gray; padding: 10px;">
      ...
      <div class="form-group">
          <table width="100%">
              <tr>
                  ...
                  <td width="70%">
                      <input type="text" class="form-control" name="jenis_memo" autocomplete="off" autofocus required="">
                  </td>
              </tr>
          </table>
      </div>
      ...
      <div class="tombol_kirim" style="text-align: center;">
        <button type="submit" class="btn btn-success">
          <i class="fa fa-send-o"></i> Simpan Format
        </button>
