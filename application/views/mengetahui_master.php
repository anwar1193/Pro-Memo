...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <td>
            ...
            <input type="text" name="departemen_mengetahui[]" value="" class="form-control" required id="mengetahui_departemen1" readonly style="background-color:white">
        ...
        <td>
            <input type="text" class="form-control" name="jabatan_mengetahui[]" value="" id="mengetahui_jabatan1" readonly style="background-color:white">

            <span id="level_mengetahui1_v" class="text-success"></span>
        </td>

        <td>
            <input type="text" class="form-control" name="username_mengetahui[]" value="" id="mengetahui_username1" readonly style="background-color:white">

            <input type="text" name="urutan_mengetahui[]" value="1" hidden>

            <input type="text" id="level_mengetahui1" value="" hidden>
        </td>
        ...
        <td>
            ...
            <span id="level_mengetahui2_v" class="text-success"></span>
        </td>
        ...
        <td>
            ...
            <input type="text" id="level_mengetahui2" hidden>
        </td>
