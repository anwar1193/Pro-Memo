<?php  
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-8 offset-2" style="border:1px dashed gray; padding: 10px;">
      ...
      <!-- Form Simpan Format -->
      <form method="post" enctype="multipart/form-data" action="<?php echo base_url().'master_user/simpan_user' ?>">
      ...
      <div class="tombol_kirim" style="text-align: center;">
        <button type="submit" class="btn btn-success">
          <i class="fa fa-send-o"></i> Simpan User
        </button>

        <a href="<?php echo base_url().'master_user' ?>" class="btn btn-danger">Kembali</a>
      </div>
