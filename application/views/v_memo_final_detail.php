                            ...
                            <?php  
                                foreach($data_mengetahui as $row_mengetahui){
                                    if($row_mengetahui['status'] == 'done'){
                                        ...
                                        echo $row_mengetahui['username_mengetahui'].'<br> <span style="background-color:orange; color:white; padding:2px; border-radius:50%"><i class="fas fa-allergies"></i></span> 
                                    ...
                                    }elseif($row_mengetahui['status'] == 'rejected'){
                                        echo $row_mengetahui['username_mengetahui'].'<br> <span style="background-color:red; color:white; padding:2px; border-radius:50%"><i class="fas fa-times"></i></span> 
                          ...
                          <td class="text-center">
                            <?php  
                                foreach($data_menyetujui as $row_menyetujui){
                                    if($row_menyetujui['status'] == 'done'){
                                    ...
                                    }elseif($row_menyetujui['status'] == 'revisi'){
                                        echo $row_menyetujui['username_menyetujui'].'<br> <span style="background-color:orange; color:white; padding:2px; border-radius:50%"><i class="fas fa-allergies"></i></span> 
                                        ...
                                        <br> ('.$row_menyetujui['jabatan_menyetujui'].')';
                                    }elseif($row_menyetujui['status'] == 'rejected'){
                                        echo $row_menyetujui['username_menyetujui'].'<br> <span style="background-color:red; color:white; padding:2px; border-radius:50%"><i class="fas fa-times"></i></span> 
